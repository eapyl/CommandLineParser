...
#pragma warning disable CS0649
        ...
        {
            [ValueArgument(ShortName = 'i', AllowMultiple = true)]
            public List<int> Numbers;

            [ValueArgument(ShortName = 'v', DefaultValue = 2, ValueOptional = true)]
            public int Version;

            [ValueArgument(ShortName = 'n', Optional = true)]
            public int? NullableInt;

            [ValueArgument(ShortName = 'b', Optional = true)]
            public bool? NullableBool;

            [ValueArgument(ShortName = 'l', DefaultValue = 0)]
            public int Length;
        }
